...
export const products: Product[] = [
  { id: "hp-probook-440", name: "HP ProBook 440 G10", brand: "HP", category: "Laptops", description: "Core i5, 16GB RAM, 512GB SSD", price: 10499, previousPrice: 11299, rating: 4.8, reviewCount: 34, status: "demo", image: hpLaptop, imageAlt: "Silver HP-style business laptop on a studio background", featured: true },
  { id: "dell-latitude-5440", name: "Dell Latitude 5440", brand: "Dell", category: "Laptops", description: "Core i7, 16GB RAM, 512GB SSD", price: 12950, rating: 4.7, reviewCount: 27, status: "demo", image: dellLatitude, imageAlt: "Dark business laptop on a studio background", featured: true },
